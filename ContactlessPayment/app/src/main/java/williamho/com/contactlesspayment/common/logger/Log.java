 ...
 * Most of the methods in this calss server only to map a method call in Log to its equivalent
 * in LogNode.</p>
 */
public class Log {
     ...
     *
     * @param tag Tag for the log data. Can be used to organise log statements.
     * @param msg The actual message to be logged.
     * @param tr If an exception was thrown, this can be sent along for the logging facilities
     *           to extract and print useful information.
     */
